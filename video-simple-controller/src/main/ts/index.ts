class MainProcess {
    ...
    readonly dropZone2 = <HTMLDivElement>document.getElementById("drop-zone2");
    readonly videoFile1 = <HTMLInputElement>document.getElementById("videoFile1");
    readonly videoFile2 = <HTMLInputElement>document.getElementById("videoFile2");


    readonly interval1 = <HTMLInputElement>document.getElementById("interval1")
    readonly interval2 = <HTMLInputElement>document.getElementById("interval2")

    readonly btnForward1 = <HTMLLabelElement>document.getElementById("btnForward1");
    readonly btnBack1 = <HTMLLabelElement>document.getElementById("btnBack1");
    readonly btnForward2 = <HTMLLabelElement>document.getElementById("btnForward2");
    readonly btnBack2 = <HTMLLabelElement>document.getElementById("btnBack2");

    readonly videoMgr1;
    readonly videoMgr2;

    private isButton1On: boolean = false;
    private isButton2On: boolean = false;
    ...
    constructor() {
        ...
        const video2 = <HTMLVideoElement>document.getElementById("video2");
        const sPanCurrentTime2 = <HTMLSpanElement>document.getElementById("currentTime2");
        const nagasa2 = <HTMLSpanElement>document.getElementById("nagasa2");
        const message2 = <HTMLSpanElement>document.getElementById("kanryou2");
