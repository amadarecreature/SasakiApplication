...
describe("KifuUtil_convertFromString", () => {
    ...
    describe("正常ケース", () => {
        it("0手", () => {
            const input = "";
            const actual = KifuController.convertFromString(input);
    ...
    describe("異常ケース", () => {
        it("(なし_2番目", () => {
            ...
            expect(() => {
                KifuController.convertFromString(input);
...
describe("KifuUtil_getPositionNo", () => {
    describe("正常系", () => {
        it("a", () => {
            const actual = KifuController.getPositionNo("a");
            expect(actual).toBe(1);
        })
        it("z", () => {
            const actual = KifuController.getPositionNo("z");
